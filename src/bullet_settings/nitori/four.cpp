...
void Four::shoot_rings() {
  ...
  int base_stop_duration = this->stop_duration_frames; // 基础停顿时间

  // 计算单个子弹间距的“半缝隙弧度” 同组内插缝
